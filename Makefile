# C Compiler
CC=avr-gcc
CFLAGS=-c -g -Os -Wall -w -ffunction-sections -fdata-sections -mmcu=atmega328p -DF_CPU=16000000L -DARDUINO=158 -DARDUINO_AVR_UNO -DARDUINO_ARCH_AVR -I libs/arduino -I libs/tetris -I libs/arduino/variants/standard -I .
